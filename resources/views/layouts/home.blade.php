    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        @foreach($sliders as $slider)
            <div class="carousel-item @if($loop->first) active @endif" style="background-image: url('{{ asset('storage/'.$slider->image) }}')">
  ...
  <div class="container col-md-8">
    ...
    <div class="row">
        <div class="col text-center">
            <a href="{{ route('project.all') }}" class="btn btn-outline-success btn-lg">Lihat Semua</a>
        </div>
    </div>
    <!-- /.row -->

    <h1 class="my-4 text-center">Cara Kerja</h1>

    <div class="row">
      @foreach($ways as $way)
      <div class="col portfolio-item">
        <div class="card h-100">
          <img class="card-img-top img-fluid" src="{{ asset('storage/'.$way->image) }}" alt="">
          <div class="card-body text-center">
            <h4 class="card-title">
              {{ $way->title }}
            </h4>
